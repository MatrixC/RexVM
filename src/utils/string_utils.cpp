...
namespace RexVM {
    ...
    std::vector<char16_t> utf8ToUtf16(const char *utf8, size_t utf8Size) {
        ...
        for (size_t i = 0; i < utf8Size; ) {
            ...
            if (codepoint <= 0xFFFF) {
                ...
                codepoint -= 0x10000;
                utf16Vec.emplace_back(static_cast<char16_t>((codepoint >> 10) + 0xD800));
                utf16Vec.emplace_back(static_cast<char16_t>((codepoint & 0x3FF) + 0xDC00));
            }
        }
