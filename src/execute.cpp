...
#ifdef LLVM_JIT
        do {
            if (!startWith(method.klass.getClassName(), "java/lang")) {
                break;
            }

            if (startWith(method.klass.getClassName(), "java/lang/Class")) {
                break;
            }

            if (startWith(method.klass.getClassName(), "java/lang/Thread")) {
                break;
            }

            if (startWith(method.klass.getClassName(), "java/lang/String")) {
                break;
            }

            if (startWith(method.klass.getClassName(), "java/lang/reflect/Constructor")) {
                if (method.getName() == "newInstance") {
                    // break;
                }
            }
