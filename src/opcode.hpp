...
namespace RexVM {
    ...
    constexpr auto OPCODE_ENUM_COUNT = 256;
    extern const std::array<cview, OPCODE_ENUM_COUNT> OPCODE_NAMES;
    cview getOpCodeName(OpCodeEnum opCode);

    bool isJumpOpCode(OpCodeEnum opCode);
    bool isReturnOpCode(OpCodeEnum opCode);
    bool isEndOpCode(OpCodeEnum opCode);
}
