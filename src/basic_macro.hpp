...
#define CAST_PRIMITIVE_CLASS(x) INSTANCE_CAST<PrimitiveClass *>(x)
#define CAST_ARRAY_CLASS(x) INSTANCE_CAST<ArrayClass *>(x)
#define CAST_OBJ_ARRAY_CLASS(x) INSTANCE_CAST<ObjArrayClass *>(x)
#define CAST_TYPE_ARRAY_CLASS(x) INSTANCE_CAST<TypeArrayClass *>(x)
